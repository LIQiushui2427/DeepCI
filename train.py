...
from Net import Discriminator,Net_X
...
if __name__ == '__main__':
    ...
    parser.add_argument("--direction", type=str, default='Y:/research', help="the file you want to run")
    ...
    parser.add_argument("--n_epoch", type=int, default=400, help="n_epochs")
    ...
    net_adversary = torch.nn.Sequential(
            torch.nn.Linear(4, args.k), #200
            torch.nn.BatchNorm1d(args.k),
            torch.nn.LeakyReLU(0.2),
            torch.nn.Linear(args.k, 256), #200
