...
if __name__ == '__main__':
    ...
    # parser.add_argument("--direction", type=str, default='/home/ubuntu/pa/DeepCI-master', help="the file you want to run")
    ...
    parser.add_argument("--data", type=str, default='mnist', help="the data you want to use")
    ...
    if args.data == 'mnist':
        ...
        # load the data set and create data loader instance
        train_loader = torch.utils.data.DataLoader(
            datasets.CIFAR10('/home/ubuntu/pa/data', train=True, download=True,
                        transform=transforms.Compose([
                            transforms.ToTensor(),
                            # if 1 channel
                            # transforms.Grayscale()
        ...
        learner = ResNet50()
        test_loader = torch.utils.data.DataLoader(
            datasets.CIFAR10('/home/ubuntu/pa/data', train=False, transform=transforms.Compose([
                            transforms.ToTensor(),
                            # if 1 channel
                            # transforms.Grayscale()
                            transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))
